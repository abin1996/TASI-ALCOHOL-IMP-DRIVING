...
# Function to get the recording file name from the string
...
# Function to get the current time in the format: dd-mm-yy_HH-MM-SS
...
# Function to call the Bash script and capture the output
...
# Function to extract the bag number from the path
...
# Function to update the output element with the given text
