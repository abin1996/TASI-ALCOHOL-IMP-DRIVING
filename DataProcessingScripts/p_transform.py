...
# This function takes in the corner positions of the calibration image and the input folder containing the images to be transformed.
# It also takes in the output folder where the transformed images will be saved.
# The function also takes in the calibration image and the flip_image parameter which is a boolean value that determines if the image should be flipped or not.
...
#Used if you want to run this script independently
